...
void initMillis() {
	...
	//--------------------------------------------------
	TCCR0 = (1<<WGM01);			//Clear TImer on Compar Match Mode (2), no pin output
	TCCR0 = (1<<CS02) | (0<<CS01) | (1<<CS00);//TOP=OCR0A, 1024 prescaler
	OCR0 = T0_RELOAD;				//244: Overflow every 15.68 ms
	TIMSK = (1<<OCIE0);
}
